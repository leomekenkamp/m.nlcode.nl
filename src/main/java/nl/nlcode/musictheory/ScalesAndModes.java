...
public class ScalesAndModes {
    ...
    public static final AscendingDescendingScale MELODIC_MINOR_SCALE = new AscendingDescendingScale("Melodic minor", ASCENDING_MELODIC_MINOR_SCALE, DESCENDING_MELODIC_MINOR_SCALE);
...
// dark to bright        LOCRIAN, PHRYGIAN, AEOLIAN, DORIAN, MIXOLYDIAN, IONIAN, LYDIAN
    ...
    public static final Mode MINOR_PENTATONIC_MODE = new Mode("Minor pentatonic", MAJOR_PENTATONIC_SCALE, 5);
